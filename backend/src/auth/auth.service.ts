...
export class AuthService {
    ...
    async register(registerDto: RegisterDto): Promise<AuthResponseDto> {
        ...
        // Create new tenant with the provided name
        const newTenant = new this.tenantModel({
            name: registerDto.tenantName,
            description: `Tenant for ${registerDto.tenantName}`,
            isActive: true,
            settings: {},
            isDeleted: false,
        });
        ...
        // Create default admin user group for the new tenant
        const newUserGroup = new this.userGroupModel({
            name: 'Admin',
            groupType: UserGroup.ADMIN,
            customPermissions: {
                canManageUsers: true,
        ...
        const userGroupId = savedUserGroup._id.toString();
    ...
    private convertTimeToSeconds(timeString: string | undefined): number {
